...
def main(argObj):
    ...
    list_All = [list_EventCharge_AllExtensions, list_DeltaEL]
    ...
    file_object_histogram = open('data_histogram_Imgs_'+str(len(argObj))+'_Sol_'+str(Solidit)+'_Elip_'+str(Elip)+'_DeltaDL_' + \
                                str(DeltaEL_range_min) + str(DeltaEL_range_max) +  '.pkl', 'wb')
