...
TFile *f_geant = new TFile("./root_files/muons_1M_vacuum_CONNIE_420x1022_SD_Log.root");
...
TFile *f_pp = new TFile("../../../../Simulacion_ab_initio/Sim_ab_initio__CONNIE_NMUONS_1000000_PLANES_1.7_RADIO_7_CCDSIZE_1022X420_SIGMA_1.0_SD_Log_BIRKS_0.6_C_.root");
