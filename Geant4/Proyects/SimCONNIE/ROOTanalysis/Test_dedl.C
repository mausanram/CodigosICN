...
TFile *f_geant = new TFile("./root_files/muons_1M_vacuum_CONNIE_420x1022_SD_Log_1.root");
TTree *tree_geant = (TTree*) f_geant->Get("B02Evts");


TFile *f_pp = new TFile("../../../../Simulacion_ab_initio/Sim_ab_initio_CONNIE_NMUONS_1000000_PLANES_1.8_RADIO_8_CCDSIZE_420X1022_C_0.root");
TTree *tree_pp = (TTree*) f_pp->Get("tree");

TFile *f_icn = new TFile("../../../../Simulacion_ab_initio/tree_muons_CONNIE_NSAMP400_1022x420_SIGMAS_5_MeV_new.root"); // INFO ALL_CLUSTERS
