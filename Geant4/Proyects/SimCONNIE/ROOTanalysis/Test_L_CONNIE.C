...
TFile *file = new TFile("./root_files/muons_1M_vacuum_CONNIE_420x1022_SD_Log.root");
TTree *tree = (TTree*) file->Get("B02Evts");

TFile *file0 = new TFile("../../../../Simulacion_ab_initio/Sim_ab_initio__CONNIE_NMUONS_1000000_PLANES_1.7_RADIO_7_CCDSIZE_1022X420_SIGMA_1.0_SD_Log_BIRKS_0.6_C_.root");
...
leg->AddEntry(L, "Sim GEANT4", "lep");
leg->AddEntry(LPP, "Sim PP", "lep");
