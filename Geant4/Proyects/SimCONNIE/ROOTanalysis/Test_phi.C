...
TFile *file_pp = new TFile("../../../../Simulacion_ab_initio/Sim_ab_initio_CONNIE_NMUONS_1000000_PLANES_1.7_RADIO_7_CCDSIZE_420X1022_C_0.root");
...
TH1F *phi_icn = new TH1F("phi_icn", "Distribuci#acute{o}n angular #phi de los muones que impactaron la CCD", NB/2, tlow, thi);
phi_icn->SetStats(0);
...
TLine *line1 = new TLine(TMath::Pi()/2,0,TMath::Pi()/2,7000);
line1->SetLineStyle(2);
line1->SetLineWidth(2);

TLine *line2 = new TLine(TMath::Pi(),0,TMath::Pi(),7200);
line2->SetLineStyle(2);
line2->SetLineWidth(2);

TLine *line3 = new TLine(3*TMath::Pi()/2,0,3*TMath::Pi()/2,7000);
...
// leg->SetHeader("", "C");
// leg->SetFillStyle(0);
leg->AddEntry(func1, "C [#frac{A_{s}}{#pi}+ #left(#frac{A_{l}}{4}#right)#left|cos#theta #right| + #left(#frac{A_{c}}{4}#right) #left|sin#theta #right| ]", "l");
