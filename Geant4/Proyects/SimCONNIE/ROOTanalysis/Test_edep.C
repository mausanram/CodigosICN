...
TFile *f_geant = new TFile("./root_files/muons_1M_vacuum_CONNIE_420x1022_SD_Log_0.root");
...
TFile *f_conn_all = new TFile("../../../../Simulacion_ab_initio/Edep_all_CONNIE_NSAMP400_1022x420_SIGMAS_5_MeV.root"); // INFO ALL_CLUSTERS
TTree *tree_conn_all = (TTree*) f_conn_all->Get("tree");

// TFile *f_conn_muons= new TFile("../../../../Simulacion_ab_initio/Edep_muons_CONNIE_NSAMP400_1022x420_SIGMAS_5_MeV.root");	// INFO MUONS ONLY
TFile *f_conn_muons = new TFile("../../../../Simulacion_ab_initio/Edep_muons_CONNIE_NSAMP400_700x420_SIGMAS_5_MeV.root"); // INFO ALL_CLUSTERS
TTree *tree_conn_muons = (TTree*) f_conn_muons->Get("tree");

TFile *f_pp = new TFile("../../../../Simulacion_ab_initio/Sim_ab_initio_CONNIE_NMUONS_1000000_PLANES_1.7_RADIO_7_CCDSIZE_420X1022_C_0.root");
TTree *tree_pp = (TTree*) f_pp->Get("tree");

TFile *f_icn = new TFile("../../../../Simulacion_ab_initio/Edep_NSAMP324_250x529_EXPOSURE_4504_MeV.root");
...
TH1F *edep_conn_all = new TH1F("edep_conn_all", "CONNIE 2021-2022", NB, tlow, thi);
edep_conn_all->SetStats(0);
edep_conn_all->SetLineStyle(1);
edep_conn_all->SetLineColor(1);

TH1F *edep_conn_muons = new TH1F("edep_conn_muons", "CONNIE 2021-2022", NB, tlow, thi);
edep_conn_muons->SetStats(0);
edep_conn_muons->SetLineStyle(1);
edep_conn_muons->SetLineColor(4);
...
tree_conn_all->Draw("edep*1000>>edep_conn_all", "edep>0"); // EXPERIMENTAL INFO CONNIE
tree_conn_muons->Draw("edep*1000>>edep_conn_muons", "edep>0"); // EXPERIMENTAL INFO CONNIE
...
double cont_conn = edep_conn_all->Integral();
...
edep_geant_scale->Scale(0.69);
edep_conn_all->Scale(7.6);
edep_conn_muons->Scale(21);
...
edep_conn_muons->Draw("hist same");
edep_conn_all->Draw("hist same"); 	// CONNIE data
...
leg->AddEntry(edep_conn_all, "Datos CONNIE-NSAMP400", "LEP");
leg->AddEntry(edep_conn_muons, "Datos de muones CONNIE-NSAMP400", "LEP");
