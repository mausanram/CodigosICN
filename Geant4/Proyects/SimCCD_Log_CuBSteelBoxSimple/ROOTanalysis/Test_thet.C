...
// TFile *file = new TFile("./root_files/muons_1M_vacuum_250x529_file_SDLog_Cu_0.root");
...
tree->Add("./root_files/muons_1M_vacuum_250x529_file_SDLog_Cu_5.root");
tree->Add("./root_files/muons_1M_vacuum_250x529_file_SDLog_Cu_6.root");
tree->Add("./root_files/muons_1M_vacuum_250x529_file_SDLog_Cu_7.root");
tree->Add("./root_files/muons_1M_vacuum_250x529_file_SDLog_Cu_8.root");
tree->Add("./root_files/muons_1M_vacuum_250x529_file_SDLog_Cu_9.root");
...
TH1F *theta_pp_in = new TH1F("theta_pp_in", "Distribuci#acute{o}n angular #theta del ICN", NB, tlow, thi);
theta_pp_in->GetXaxis()->SetTitle("#theta(rad)");
theta_pp_in->SetLineColor(4);
// theta_cut->SetStats(0);
