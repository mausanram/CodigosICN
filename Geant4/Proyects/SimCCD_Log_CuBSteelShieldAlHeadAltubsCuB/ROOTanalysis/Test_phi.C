...
tree->Draw("(phiPri + TMath::Pi())>>phi_in", "nHitBar>0 && LengthMuLAr>0");
// tree->Draw("(phiPri + TMath::Pi())>>phi_in", "nHitBar>0");
tree->Draw("(phiPri + TMath::Pi())>>phi_cut", "nHitBar>0 && LengthMuLAr>0 && thetaPri > 20*TMath::Pi()/180");
