...
tree->Draw("EevtPri*1000>>thet_0_6", "thetaPri>0 && thetaPri<(4*TMath::Pi()/180)");
tree->Draw("EevtPri*1000>>thet_43_47", "thetaPri>(44.5*TMath::Pi()/180) && thetaPri<(45.5*TMath::Pi()/180)");
tree->Draw("EevtPri*1000>>thet_73_77", "thetaPri>(74.5*TMath::Pi()/180) && thetaPri<(75.5*TMath::Pi()/180)");

tree->Draw("EevtPri*1000>>thet_0_6Log", "thetaPri>0 && thetaPri<(4*TMath::Pi()/180)");
tree->Draw("EevtPri*1000>>thet_43_47Log", "thetaPri>(44.5*TMath::Pi()/180) && thetaPri<(45.5*TMath::Pi()/180)");
tree->Draw("EevtPri*1000>>thet_73_77Log", "thetaPri>(74.5*TMath::Pi()/180) && thetaPri<(75.5*TMath::Pi()/180)");
...
// leg->SetHeader("", "C");
leg->SetFillStyle(0);
leg->AddEntry(Smith0, "Smith-Duller Curve: #theta = 0", "l");
leg->AddEntry(Smith45, "Smith-Duller Curve: #theta = #frac{#pi}{4}", "l");
leg->AddEntry(Smith75, "Smith-Duller Curve: #theta = #frac{5#pi}{12}", "l");
