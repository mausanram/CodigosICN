...
TLine *line1 = new TLine(TMath::Pi()/2,0,TMath::Pi()/2,line_hight);
line1->SetLineStyle(2);
line1->SetLineWidth(2);

TLine *line2 = new TLine(TMath::Pi(),0,TMath::Pi(),line_hight);
line2->SetLineStyle(2);
line2->SetLineWidth(2);

TLine *line3 = new TLine(3*TMath::Pi()/2,0,3*TMath::Pi()/2,line_hight);
