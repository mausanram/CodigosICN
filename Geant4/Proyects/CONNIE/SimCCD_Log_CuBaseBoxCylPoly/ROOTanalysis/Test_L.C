...
tree->Add("./root_files/muons_1M_vacuum_420x1022_file_SDLog_*.root");
...
const double ccd_thickness = 0.0675; // cm
//TLine *line = new TLine(0.0725,0,0.0725,30000);
TLine *line = new TLine(ccd_thickness,0,ccd_thickness,7000);
line->SetLineStyle(2);
line->SetLineWidth(2);
...
leg->AddEntry(line, "Grosor de CCD: 0.0675 cm", "l");
leg->Draw();
