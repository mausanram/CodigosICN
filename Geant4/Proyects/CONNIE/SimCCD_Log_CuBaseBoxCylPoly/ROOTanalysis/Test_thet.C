...
tree->Add("./root_files/muons_1M_vacuum_420x1022_SDLog_*.root");
...
// ====================== Función para la CCD =========================== //
double px_size = 0.0015; // cm     
double y_size = 1022;   // px
double x_size = 682;    // px
double z_size = 0.0675; // micras

double Ah = y_size * x_size * pow(px_size,2);
double Al = y_size * z_size * px_size;
double Ac = x_size * z_size * px_size;
