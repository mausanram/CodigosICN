...
number_of_points_per_plane = 100
...
for i in np.arange(0,len(Theta)):
    ...
    plane = Plane(normal_vec = Vec, d_origin = Radio, ref_point = Point, radius = 60)   ## Se crea el plano sobre la esfera
                                                                                        ## El término 'radius' es el que maneja el tamaño del plano.
    
    for i in np.arange(0,number_of_points_per_plane):
