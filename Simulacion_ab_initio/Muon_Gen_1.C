...
double LV(double *lx, double *lpar) {
	...
	if (kappa<=0.01) {
		...
		double phi = TMath::Landau(lambda, lambdamp, 0.3);
...
void Muon_Gen_1(){
    ...
    TFile *file = TFile::Open("Sim_ab_initio_NMUONS_1000000_PLANES_1.5_RADIO_8_CCDSIZE_250X529_SIGMA_0.3_C_0.root", "recreate");
